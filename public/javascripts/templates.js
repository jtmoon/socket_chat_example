...
function program3(depth0,data) {
  ...
  data.buffer.push(escapeExpression(stack1) + "\n    <div>\n      <button\n      ");
  stack1 = {};
  stack2 = ":btn view.isUser::disabled";
  stack1['class'] = stack2;
...
Ember.TEMPLATES["messagesView"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
helpers = helpers || Ember.Handlebars.helpers;
...
function program1(depth0,data) {
  ...
  data.buffer.push("<ul class=\"nav nav-list well chat-window\">\n  ");
  stack1 = depth0;
  stack2 = "controller";
  stack3 = helpers.each;
  tmp1 = self.program(1, program1, data);
...
Ember.TEMPLATES["messageView"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
helpers = helpers || Ember.Handlebars.helpers;
  var buffer = '', stack1, stack2, stack3, stack4, tmp1, self=this, functionType="function", helperMissing=helpers.helperMissing, undef=void 0, escapeExpression=this.escapeExpression;
...
Ember.TEMPLATES["roomsView"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
helpers = helpers || Ember.Handlebars.helpers;
  var buffer = '', stack1, stack2, stack3, stack4, tmp1, self=this, functionType="function", helperMissing=helpers.helperMissing, undef=void 0, escapeExpression=this.escapeExpression;
...
function program1(depth0,data) {
  ...
  data.buffer.push("<a class=\"brand\">");
  stack1 = depth0;
  stack2 = "Chat.currentUser.user.user_name";
  stack3 = {};
  stack4 = "true";
  stack3['escaped'] = stack4;
  stack4 = helpers._triageMustache || depth0._triageMustache;
...
Ember.TEMPLATES["roomView"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
helpers = helpers || Ember.Handlebars.helpers;
  var buffer = '', stack1, stack2, stack3, stack4, tmp1, self=this, functionType="function", helperMissing=helpers.helperMissing, undef=void 0, escapeExpression=this.escapeExpression;
...
Ember.TEMPLATES["usersView"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
helpers = helpers || Ember.Handlebars.helpers;
  var buffer = '', stack1, stack2, stack3, stack4, tmp1, self=this, functionType="function", helperMissing=helpers.helperMissing, undef=void 0, escapeExpression=this.escapeExpression;
...
function program1(depth0,data) {
  ...
  data.buffer.push("<ul class=\"nav nav-list well\">\n  <li class=\"nav-header\">Users: ");
  stack1 = depth0;
  stack2 = "view.userCount";
  stack3 = {};
  stack4 = "true";
  stack3['escaped'] = stack4;
  stack4 = helpers._triageMustache || depth0._triageMustache;
...
Ember.TEMPLATES["userView"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
helpers = helpers || Ember.Handlebars.helpers;
  var buffer = '', stack1, stack2, stack3, stack4, tmp1, self=this, functionType="function", helperMissing=helpers.helperMissing, undef=void 0, escapeExpression=this.escapeExpression;
